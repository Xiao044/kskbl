...
.radar-stage { flex: 2; min-width: 0; background: rgba(250, 249, 247, 0.5); border-radius: 16px; padding: 20px; border: 1px solid rgba(218,212,200,0.38); box-sizing: border-box; }
